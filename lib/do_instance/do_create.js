...
do_create.options = [
    ...
    },
    {
        ...
        type: 'arrayOfString',
        helpArg: 'FILE',
        help: 'Load a file to be used for the cloud-init user-data. If ' +
            'cloud-init is installed in the guest image it will use ' +
            'this data to configure the instance at provision time. ' +
            'This is a shortcut for `-M cloud-init:user-data=FILE`. ' +
