        ...
        function createInst(ctx, next) {
            ...
            for (var i = 0; i < opts._order.length; i++) {
                ...
                if (opt.key === 'firewall') {
                    ...
                    var allowed_delegate_vals = ['on', 'off'];
...
do_create.options = [
    ...
    },
    {
        ...
        help: 'Enable Delegated Datasets on this instance. If TYPE is set to ' +
              '"on", delegated datasets are enabled, though the instance is ' +
    ...
    },
    {
        ...
        help: 'Place this instance into an encrypted Compute Node. The ' +
            ...
            // JSSTYLED
            '<https://github.com/joyent/rfd/blob/master/rfd/0077/README.adoc#customer-features>'
    },
    {
        names: ['volume', 'v'],
        type: 'arrayOfString',
