        ...
        function generateAndSignCert(arg, next) {
            ...
            if (certSignKey.type === 'ed25519') {
                console.log(wordwrap('\nThe provided Triton profile: "' +
                    opts.name + '" is using an ED25519 key which can not be ' +
                    'used for generating CMON certificates until EDDSA is ' +
            ...
            kr.findSigningKeyPair(profileFp,
                ...
                if (keyPair.getPublicKey().type === 'ed25519') {
                    console.log(wordwrap('\nThe provided Triton profile: "' +
                        ...
                        'be used for generating Docker client certificates ' +
                        'until EDDSA is adopted by the CA/Browser Forum. Use ' +
                        'an RSA or ECDSA key to generate a Docker client ' +
                        'certificate.\n'));
                    next(new Error('ED25519 not supported.'));
                    return;
                }
